...
public class LEArgumentFunction extends LEArgument {
	...
	public LEArgumentFunction(LiteralName name) {
		super(name);
		Function = new LEPredicate(name.NameParts);
	}

	
	
	public void addArgumentToFunction(LEArgument argument) {
	 ...
	 * @return the function
	 */
	public LEPredicate getFunction() {
		return Function;
	}
